      ...
      >
        <div className="card-panel p-10 rounded-3xl relative overflow-hidden backdrop-blur-2xl">
          ...
          <div className="text-center mb-10">
            <img src="https://pub-36b2d25ce1714b7cbf09504e3ad53fae.r2.dev/spacex-removebg-preview.png" alt="SpaceX" className="h-56 mx-auto mb-10 object-contain brightness-0 invert opacity-95" referrerPolicy="no-referrer" />
